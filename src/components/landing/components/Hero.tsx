...
export default function Hero() {
  return (
    ...
    >
      ...
      <motion.div initial={{ scale: 1.2, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ duration: 1.2, ease: "easeOut" }} className="absolute inset-0">
        <Image src="/images/ImagenTecnica1.jpg" alt="CEPRE UNAJMA" fill className="object-cover object-center" />
      </motion.div>
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/40 to-transparent flex items-center justify-center">
        <motion.div className="text-center text-white px-4" variants={itemVariants}>
          ...
          <motion.div whileHover={{ scale: 1.1, boxShadow: "0px 0px 15px rgba(255, 140, 0, 0.8)" }} whileTap={{ scale: 0.95 }}>
            <Link href="/carreras" className="bg-orange-500 text-white px-8 py-3 rounded-lg font-semibold tracking-wide  hover:bg-orange-600 transition duration-300 shadow-lg hover:shadow-xl">
